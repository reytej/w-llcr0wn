												...
												<?php foreach ($contents as $record): ?>
													<form name="form1" id="ff" method="post" action="<?php echo base_url() . "site_1/update"?>">
														...
														<label class="row">
															<div class="col-1-2">
																<div class="wrap-col">
																	<input type="hidden" name="contentimage" id="ff" placeholder="Enter image Name" required="required" value="<?php echo $record->image; ?>"/>
																</div>
															</div>
														</label>
														<label class="row">
															<div class="wrap-col">
																<input type="hidden" name="contenttitle"  placeholder="Enter Title" required="required" value="<?php echo $record->title; ?>"/>
															</div>
														</label>
														<label class="row">
															<div class="wrap-col">
																Contents:<textarea name="contentdescription"  class="form-control" rows="4" cols="25" required="required"
