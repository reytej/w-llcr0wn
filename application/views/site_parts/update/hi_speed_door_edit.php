										...
										<div class="contact">
											<div id="contact_form">
												<?php foreach ($hi_speed_door as $record): ?>
													<form name="form1" id="ff" method="post" action="<?php echo base_url() . "site_1/hi_speed_door_edit"?>">
														<label class="row">
															<div class="col-1-2">
																<div class="wrap-col">
														...
														<center><input class="sendButton" type="submit" id="submit"name="edit_hi_speed_door" value="Submit"></center>
													</form>
												<?php endforeach; ?>
											</div>
										</div>
