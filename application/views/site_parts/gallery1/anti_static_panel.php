			...
			<ARTICLE><CENTER><font color="ee7600 "><h1>ANTI-STATIC PANEL</h1></font></CENTER></ARTICLE>

		<section class="content-box box-1 box-style-1"><!--Start Box-->
			<div class="zerogrid">
				<div class="row">
				<?php foreach($anti_static_panel as $row):?>
						<div class="col-1-3">
								<div class="wrap-col ">
									<div class="item">
										<div class="zoom-container">
											...
											<div class="item-content">
												...
												'.$row->description.'';?>
											<div align="right">
												<a href="<?php echo base_url() . 'site_1/anti_static_panel_edit/' . $row->id; ?>"><font color="ee7600 ">[EDIT]</font></a>
											</div>	
											<div align="right">
												<a href="<?php echo base_url() . 'site_1/delete_anti_static_panel/' . $row->id; ?>"><font color="ee7600 ">[DELETE]</font></a>
											</div>																								
											</div>
									</div>
								</div>
